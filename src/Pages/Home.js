...
const Home = () => {
  ...
  return (
    <div className='relative'>
      {/* section 1 */}
      <div className="relative mx-auto flex flex-col max-w-maxContent w-11/12 items-center justify-between">
        <Link to={"/signup"}>
        ...
        <div className='mx-3 my-[70px] shadow-abc w-full overflow-hidden'>
          <img src={boxOffice} className='w-full object-cover' alt="Box Office"/>
        </div>

        <div className='w-full'>
          <CodeBlocks
            heading={<div className='text-4xl font-semibold'>Unlock Your <HighlightText text={"coding potential"} a="#12D8FA" b="#12D8FA" c="#A6FFCB"/>  with our online courses.</div>}
        ...
        <div className='w-full'>
          <CodeBlocks
            heading={<div className='text-4xl font-semibold w-full md:w-[45%]'> Start <HighlightText text={"coding in seconds"} a="#12D8FA" b="#12D8FA" c="#A6FFCB"/> </div>}
      ...
      <div className='bg-pure-greys-5 text-richblack-700 mt-44'>
        ...
        <div className='max-w-maxContent w-11/12 mx-auto flex flex-col items-center justify-between gap-7'>
          <div className='flex flex-col lg:flex-row gap-8 mt-24'>
            <div className='text-4xl font-semibold font-inter lg:w-[45%]'>
      ...
      {/* section 3 */}
      <div className='w-11/12 max-w-maxContent flex flex-col justify-between gap-8 items-center mx-auto'>
        <Instructor/>
